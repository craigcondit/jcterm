...
/* JCTermJ2MECDC
 * Copyright (C) 2004 ymnk, JCraft,Inc.
 *  
 * Written by: 2004 ymnk<ymnk@jcaft.com>
 *   
 *   
...
//System.out.println("char_width: "+char_width+" "+char_height);
  ...
  public void keyPressed(KeyEvent e){
    ...
    //System.out.println("keychar: "+Integer.toHexString(keychar));
    int mod=e.getModifiers();
    //System.out.println("mod: "+Integer.toHexString(mode));
...
//    m.add(mi);
  ...
  public void setBGround(Object b){
    ...
    Graphics foog=(Graphics)(background.getGraphics());
    foog.setColor(bground);
    foog.fillRect(0, 0, char_width, char_height);
    foog.dispose();
  } 
